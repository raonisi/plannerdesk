...
import { WORK_TOOL_GROUPS, type WorkToolItem, type WorkToolKind } from "@/lib/work-tools/work-tool-groups";
import type { WorkToolCatalogId } from "@/lib/work-tools/work-tool-catalog";
import {
...
type ToolId = WorkToolCatalogId;
const STORAGE_KEY = "plannerdesk.workTools.favorites";

const visibleToolGroups = filterPublicWorkToolGroups(WORK_TOOL_GROUPS);
const statsCards = [
  {
    title: "5060 보장 점검",
    stat: "실손·진단비·간병 리스크",

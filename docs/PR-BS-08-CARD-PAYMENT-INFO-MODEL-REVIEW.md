...
관련 선행 문서: [PR-BS-04 Official Work Link Review](./PR-BS-04-OFFICIAL-WORK-LINK-REVIEW.md), [INSURER_ACTION_FIELD_EXPANSION_PLAN.md](./INSURER_ACTION_FIELD_EXPANSION_PLAN.md), [PR-170-PAYMENT-ARCHITECTURE-PLAN-OPS.md](./PR-170-PAYMENT-ARCHITECTURE-PLAN-OPS.md). 후속 구현: [PR-BS-17 Card Payment Info Policy Gate](./PR-BS-17-CARD-PAYMENT-INFO-POLICY-GATE.md).

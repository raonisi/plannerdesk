...
See [docs/ADMIN_CRUD_ARCHITECTURE.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/ADMIN_CRUD_ARCHITECTURE.md) for the future Admin CRUD architecture plan, [docs/ADMIN_ACCESS_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/ADMIN_ACCESS_PLAN.md) for the minimal admin access plan, [docs/RBAC_FOUNDATION_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/RBAC_FOUNDATION_PLAN.md) for the planned Role-Based Access Control rules, [docs/AUTH_DATABASE_SCHEMA_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/AUTH_DATABASE_SCHEMA_PLAN.md) for the Auth database schema plan, [docs/INSURER_ACTION_FIELD_EXPANSION_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/INSURER_ACTION_FIELD_EXPANSION_PLAN.md) for the planned evolution of the basic insurer directory into a practical insurer action center, [docs/CORRECTION_REQUEST_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/CORRECTION_REQUEST_PLAN.md) for the future correction request feature plan, [docs/CORRECTION_REQUEST_POLICY.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/CORRECTION_REQUEST_POLICY.md) for the correction request operating policy and safety boundaries, [docs/CORRECTION_REQUEST_DB_PLAN.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/CORRECTION_REQUEST_DB_PLAN.md) for the pre-implementation DB planning guide, [docs/KNOWLEDGE_ARCHIVE_IA.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/KNOWLEDGE_ARCHIVE_IA.md) for the knowledge archive IA foundation before community and AI assistant expansions, [docs/KNOWLEDGE_CONTENT_POLICY.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/KNOWLEDGE_CONTENT_POLICY.md) for writing/review/publishing operating rules of knowledge archive content, and [docs/PR-BS-01-FEATURE-BENCHMARK-REPORT.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/PR-BS-01-FEATURE-BENCHMARK-REPORT.md) for the benchmark report of external public features, and [docs/PR-BS-08-CARD-PAYMENT-INFO-MODEL-REVIEW.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/PR-BS-08-CARD-PAYMENT-INFO-MODEL-REVIEW.md) for card payment and premium payment reference info model review (not PlannerDesk PG billing), and [docs/PR-BS-09-CODE-SEARCH-BOUNDARY-REVIEW.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/PR-BS-09-CODE-SEARCH-BOUNDARY-REVIEW.md) for diagnosis/surgery code search boundary review (no public code search), and [docs/PR-BS-19-PUBLIC-BETA-READINESS-REVIEW.md](file:///c:/work/plannerdesk/plannerdesk-main/docs/PR-BS-19-PUBLIC-BETA-READINESS-REVIEW.md) for the PR-BS-10~18 public beta readiness review (Codex limited review: **STOP** — `public/claim-forms/bohumschool` PDF assets; does not launch public beta). These documents outline the structural layout for the data layer and routing shells.

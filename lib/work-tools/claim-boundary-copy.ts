...
/** @deprecated Import from code-search-safety — kept for PR-173-C tests. */
export { CODE_SEARCH_FORBIDDEN_UI_PHRASES as WORK_TOOLS_CODE_SEARCH_FORBIDDEN_PHRASES } from "./code-search-safety";

...
export const colors = {
  ...
  /** WCAG AA secondary on ivory/cream (~4.6:1) — was #4A5565 (~3.8:1) */
  bodyGray: "#4A5565",
  /** Small labels / badge copy on light surfaces */
  mutedGray: "#475569",
} as const;
...
export const textStyles = {
  ...
  body: "text-base leading-7 text-[#4A5565]",
  small: "text-sm leading-6 text-[#4A5565]",
...
export const statusBadgeClasses: Record<VerificationStatus, string> = {
  draft: "border-[#E3DED4] bg-slate-50 text-slate-600 rounded-md text-xs px-2 py-0.5",
...
export const buttons = {
  ...
  ghost: `text-[#4A5565] hover:bg-[#F7F4EE] hover:text-[#0F1D2E]`,
  navActive: "bg-[#F7F4EE] text-[#0F1D2E]",
  navIdle: "text-[#4A5565] hover:bg-[#F7F4EE] hover:text-[#0F1D2E]",
...
export const touchTargets = {
  ...
  paginationButton:
    "inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg border border-slate-200 text-xs font-semibold transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0F1D2E]/35 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-40",
} as const;

export const notices = {
  box: "rounded-xl border border-[#E3DED4] bg-[#F7F4EE] p-5 sm:p-6 shadow-sm",
  boxTitle: "text-sm font-bold text-[#0F1D2E]",
  boxBody: "mt-2 break-keep text-sm leading-relaxed text-[#4A5565]",
  safety: "rounded-xl border-l-4 border-[#B9975B] bg-[#F7F4EE] p-5 sm:p-6 shadow-sm",
  safetyTitle: "text-sm font-bold text-[#0F1D2E]",
  safetyBody: "mt-2 break-keep text-sm leading-relaxed text-[#4A5565]"
} as const;

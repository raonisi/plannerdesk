...
export const ANSWER_ASSIST_PAGE_NOTICES = {
  ...
  sensitiveInput:
    "고객명, 주민번호, 연락처, 계약번호, 증권번호, 병력·진단명 원문, 상담 원문 전체, 청구자료는 입력하지 마세요. 민감정보를 제외하고 상황을 요약해 입력해 주세요.",
  prohibitedScope:
    "보험금 지급 확정·가능 여부 단정, 손해사정성 판단, 의료정보 해석, 특정 상품 가입 유도, 공포 조장, 투자 매수·매도 권유는 제공하지 않습니다.",
  footerDisclaimer:
...
/** PR-137: visible on verified panel when generation is enabled. */
export const VERIFIED_ANSWER_ASSIST_RESTRICTION_NOTICE =
  "제한 beta: allowlist에 등록된 검증 설계사만 서버에서 초안 생성이 가능합니다. 접근 범위·allowlist·rate limit은 이 PR에서 완화하지 않습니다.";

...
export const insurerCardMissingSlot =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 text-sm font-medium text-slate-600 break-words whitespace-normal text-center";
...
export const insurerCardClaimNotice =
  "border-t border-slate-200 pt-3 text-xs leading-relaxed text-slate-600";
...
export const insurerCardTrustNote =
  "rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-medium leading-relaxed text-slate-600";
...
export const insurerCardClaimSearchInput = `min-h-[44px] w-full min-w-0 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm transition placeholder:text-slate-500 focus-visible:border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2`;

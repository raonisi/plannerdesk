---
name: codex-fintech-engineer
description: Applies when a task needs financial systems engineering across ledgers, reconciliation, transfers, settlement, or compliance-sensitive transactional flows. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-fintech-engineer.
---
...
- Full agent definition: `.codex/agents/fintech-engineer.toml`

---
name: codex-test-automator
description: Applies when a task needs implementation of automated tests, test harness improvements, or targeted regression coverage. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-test-automator.
---
...
- Full agent definition: `.codex/agents/test-automator.toml`

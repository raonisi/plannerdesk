---
name: codex-qa-expert
description: Applies when a task needs test strategy, acceptance coverage planning, or risk-based QA guidance for a feature or release. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-qa-expert.
---
...
- Full agent definition: `.codex/agents/qa-expert.toml`

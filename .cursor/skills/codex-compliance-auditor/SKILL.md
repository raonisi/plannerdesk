---
name: codex-compliance-auditor
description: Applies when a task needs compliance-oriented review of controls, auditability, policy alignment, or evidence gaps in a regulated workflow. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-compliance-auditor.
---
...
- Full agent definition: `.codex/agents/compliance-auditor.toml`

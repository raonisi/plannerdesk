...
description: Applies when a task needs a broader code-health review covering maintainability, design clarity, and risky implementation choices in addition to correctness. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-code-reviewer.
---
...
- Full agent definition: `.codex/agents/code-reviewer.toml`

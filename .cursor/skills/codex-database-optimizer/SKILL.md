---
name: codex-database-optimizer
description: Applies when a task needs database performance analysis for query plans, schema design, indexing, or data access patterns. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-database-optimizer.
---
...
- Full agent definition: `.codex/agents/database-optimizer.toml`

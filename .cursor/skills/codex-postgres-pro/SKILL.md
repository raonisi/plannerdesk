---
name: codex-postgres-pro
description: Applies when a task needs PostgreSQL-specific expertise for schema design, performance behavior, locking, or operational database features. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-postgres-pro.
---
...
- Full agent definition: `.codex/agents/postgres-pro.toml`

---
name: codex-git-workflow-manager
description: Applies when a task needs help with branching strategy, merge flow, release branching, or repository collaboration conventions. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-git-workflow-manager.
---
...
- Full agent definition: `.codex/agents/git-workflow-manager.toml`

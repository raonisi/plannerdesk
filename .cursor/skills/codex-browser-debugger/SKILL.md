---
name: codex-browser-debugger
description: Applies when a task needs browser-based reproduction, UI evidence gathering, or client-side debugging through a browser MCP server. Use on PlannerDesk (insurance-planner B2B portal) tasks matching this specialty, or when the user invokes codex-browser-debugger.
---
...
- Full agent definition: `.codex/agents/browser-debugger.toml`
